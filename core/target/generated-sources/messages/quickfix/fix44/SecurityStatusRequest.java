...
public class SecurityStatusRequest extends Message {
    ...
    public SecurityStatusRequest(
        quickfix.field.SecurityStatusReqID securityStatusReqID,
    ...
    public quickfix.field.SecurityStatusReqID get(
        quickfix.field.SecurityStatusReqID value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.SecurityStatusReqID getSecurityStatusReqID()
